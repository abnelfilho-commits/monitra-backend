...
class ModelContractTests(unittest.TestCase):
    def test_all_mapped_columns_match_physical_contract(self):
        ...
        for name, table in Base.metadata.tables.items():
            if name in {"servicos_economicos", "tabelas_preco", "tabela_preco_versoes", "precos_servico", "contratos_financeiros", "paciente_contratos", "mapeamentos_agenda_servico", "capacidade_instalada", "usuario_instituicao_acessos", "institucional_operacoes", "identidade_operacoes", "pessoas", "instituicoes", "instituicao_papeis", "paciente_instituicoes", "profissional_instituicoes", "paciente_profissionais"}:
